package com.example.auth.modular.consts.enums;

import com.example.auth.core.consts.SysExpEnumConstant;
 ...
 * @description
 */
@ExpEnumType(module = SysExpEnumConstant.SYS_MODULE_EXP_CODE, kind = SysExpEnumConstant.SYS_CONFIG_EXCEPTION_ENUM)
